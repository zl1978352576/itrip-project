...
public class ItripHotelKeywordServiceImpl implements ItripHotelKeywordService {
    ...
    public Integer itriptxAddItripHotelKeyword(ItripHotelKeyword itripHotelKeyword)throws Exception{
            ...
            return itripHotelKeywordMapper.insertItripHotelKeyword(itripHotelKeyword);
    }
    ...
    public Page<ItripHotelKeyword> queryItripHotelKeywordPageByMap(Map<String,Object> param,Integer pageNo,Integer pageSize)throws Exception{
        Integer total = itripHotelKeywordMapper.getItripHotelKeywordCountByMap(param);
        pageNo = EmptyUtils.isEmpty(pageNo) ? Constants.DEFAULT_PAGE_NO : pageNo;
        pageSize = EmptyUtils.isEmpty(pageSize) ? Constants.DEFAULT_PAGE_SIZE : pageSize;
        Page page = new Page(pageNo, pageSize, total);
        param.put("beginPos", page.getBeginPos());
        param.put("pageSize", page.getPageSize());
        List<ItripHotelKeyword> itripHotelKeywordList = itripHotelKeywordMapper.getItripHotelKeywordListByMap(param);
        page.setRows(itripHotelKeywordList);
        return page;
    }
